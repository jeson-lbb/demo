...
Log_name=$(basename `find ${install_dir_tar_gz} -type f -name "nginx-1.12.2.tar.gz"`)
...
# 安装Nginx主程序
tar zxf $(find ${install_dir_tar_gz} -type f -name "nginx-1.12.2.tar.gz") -C /application/tar_xzf
