...
# 测试环境用：
/bin/cp -ab /Nginx-web-server/conf/php.ini /application/php/lib/php.ini
# 创建php-fpm.conf配置文件
/bin/cp -ab /Nginx-web-server/conf/php-fpm.conf /application/php/etc/php-fpm.conf
mkdir -p /application/php-5.6.35/log
touch /application/php-5.6.35/log/www.log.slow
id www &>/dev/null || /application/php/sbin/php-fpm 
...
/bin/cp -ab /Nginx-web-server/scripts/phar_install.exp  /server/scripts
